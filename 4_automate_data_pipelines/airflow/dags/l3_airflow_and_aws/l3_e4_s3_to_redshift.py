...
def load_data_to_redshift():
    ...
    drop_station_traffic_task = PostgresOperator(
        task_id="drop_station_traffic_table",
        postgres_conn_id="redshift",
        sql=sql_statements.DROP_STATION_TRAFFIC_TABLE_SQL,
    )
    ...
    drop_station_traffic_task >> location_traffic_task
